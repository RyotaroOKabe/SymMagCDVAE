...
nice python scripts/compute_metrics.py --root_path /home/rokabe/data2/generative/hydra/singlerun/2023-09-07/carbon1 --tasks recon gen opt	# command or script to run; can use 'nvidia-smi' as a test
