...
nice python scripts/compute_metrics_v1.py --root_path /home/rokabe/data1/generative/cdvae/hydra/singlerun/2023-01-12/carbon_def  --tasks recon gen opt 	# command or script to run; can use 'nvidia-smi' as a test
