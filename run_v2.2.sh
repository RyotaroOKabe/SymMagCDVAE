...
#SBATCH --job-name=run		# a desired name to appear alongside job ID in squeue
...
nice python cdvae/run_sym_v1.py data=carbon expname=carbon_sym model.predict_property=True
