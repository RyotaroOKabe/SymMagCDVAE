...
nice python scripts/evaluate_sgo.py --model_path /home/rokabe/data2/generative/magcdvae/hydra/singlerun/2023-04-07/mp_20_sgo2 --tasks recon gen opt --save_traj True
