...
nice python scripts/evaluate_sgo.py --model_path /home/rokabe/data2/generative/magcdvae/hydra/singlerun/2023-04-07/mp_20_sgo3 --tasks opt --save_traj True --batch_size 20
