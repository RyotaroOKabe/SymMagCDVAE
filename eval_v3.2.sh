...
nice python scripts/evaluate_sgo.py --model_path /home/rokabe/data2/generative/hydra/singlerun/2023-05-03/mp_20_sgo64 --tasks recon gen opt --save_traj True --batch_size 20
