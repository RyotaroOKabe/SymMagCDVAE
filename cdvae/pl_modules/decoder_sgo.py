...
from cdvae.pl_modules.space_group import esgo_repeat
...
class GemNetTDecoder(nn.Module):
    ...
    def forward(self, z, esgo, pred_frac_coords, pred_atom_types, num_atoms,
                lengths, angles):
        """
        args:
