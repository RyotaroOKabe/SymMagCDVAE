...
nice python scripts/evaluate.py --model_path /home/rokabe/data2/generative/hydra/singlerun/2023-09-07/perov1 --tasks recon gen opt --save_traj True	# --batch_size 20
