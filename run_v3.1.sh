...
#SBATCH --job-name=gen		# a desired name to appear alongside job ID in squeue
...
nice python cdvae/run.py data=mp_20 expname=mp20_12 model.predict_property=True
