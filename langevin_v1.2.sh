...
nice python langevin.py --model_path /home/rokabe/data2/generative/hydra/singlerun/2023-05-18/mp_20_1 --tasks gen --sg 191 --label n1a100 --alpha 100 --save_traj True
