...
nice python scripts/evaluate.py --model_path /home/rokabe/data2/generative/hydra/singlerun/2023-05-18/mp_20_1 --tasks recon gen opt --save_traj True	# --batch_size 20
