...
nice python scripts/evaluate.py --model_path /home/rokabe/data2/generative/magcdvae/hydra/singlerun/2023-04-13/mp_20 --tasks recon gen opt --save_traj True	# --batch_size 20
