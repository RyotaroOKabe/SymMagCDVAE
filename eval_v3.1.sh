...
nice python scripts/evaluate.py --model_path /home/rokabe/data2/generative/hydra/singlerun/2023-10-07/mp20_1 --tasks recon gen opt --save_traj True	# --batch_size 20
