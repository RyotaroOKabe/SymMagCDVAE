...
nice python scripts/compute_metrics.py --root_path /home/rokabe/data2/generative/hydra/singlerun/2023-05-18/mp_20_1 --tasks recon gen opt 	# command or script to run; can use 'nvidia-smi' as a test
