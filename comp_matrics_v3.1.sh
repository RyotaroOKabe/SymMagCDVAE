...
nice python scripts/compute_metrics.py --root_path /home/rokabe/data2/generative/magcdvae/hydra/singlerun/2023-04-09/mp_20_full --tasks recon gen opt 	# command or script to run; can use 'nvidia-smi' as a test
