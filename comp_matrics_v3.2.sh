...
nice python scripts/compute_metrics_sgo.py --root_path /home/rokabe/data2/generative/hydra/singlerun/2023-05-18/mp_20_1 --label 1 --tasks gen	# command or script to run; can use 'nvidia-smi' as a test
